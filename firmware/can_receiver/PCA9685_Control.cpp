...
{
    freq *= 0.9;
    const float prescaleValue = 25000000.0 / 4096.0 / freq - 1.0;
    const uint8_t prescale = static_cast<uint8_t>(floor(prescaleValue + 0.5));

    const uint8_t oldmode = readRegister(MODE1_REG);
